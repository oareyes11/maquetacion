export const Footer = () => {
  return (
    <>
      <div className="w-full flex flex-col items-center h-[1381px] md:h-[800px] xl:h-[526px] bg-blueDarkPrimary">
        {/* <div className="flex w-full lg:w-[1050px] xl:w-full h-[138px] grid grid-cols-1 md:grid-cols-2 gap-4 ">
        ...
        <div className="flex w-full xl:w-[1050px] xl:w-full h-[138px] grid grid-cols-1 md:grid-cols-2 gap-4 ">
          <h3 className="flex items-center justify-center  text-graySecondary">
            Litigada
          </h3>
          <div className="flex items-center justify-center ">
        ...
        <hr />
        <div className="flex pl-5 xl:pl-0 w-full xl:w-[1050px] h-[1381px] md:h-[310px] grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
